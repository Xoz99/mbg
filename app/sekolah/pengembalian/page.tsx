...
const PengembalianMakanan = () => {
  ...
  }, [step, selectedCameraId, cameraReady, isCameraActive])
    ...
    <SekolahLayout currentPage="pengembalian">
          ...
          {!cameraReady ? (
            ...
            <div className="relative bg-black h-[350px] md:h-[450px]">
              ...
              <div className="absolute top-4 right-4">
                <button onClick={handleReset} className="p-2 bg-black/40 text-white rounded-full hover:bg-black/60 transition-all">
      ...
      {step === "processing-face" && (
        <div className="w-full bg-white rounded-xl border border-gray-100 p-12 text-center mx-auto shadow-sm">
          {facePhoto && <img src={facePhoto} className="w-24 h-24 rounded-full mx-auto mb-6 object-cover border-4 border-gray-100 transform scale-x-[-1]" />}
        ...
        <div className="w-full bg-white rounded-xl border border-gray-100 overflow-hidden mx-auto shadow-sm">
          ...
          <div className="p-4">
            <div className="flex items-center gap-4 bg-gray-50 p-4 rounded-xl mb-4 border border-gray-100">
              <img src={selectedSiswa.fotoUrl || "/placeholder.svg"} className="w-16 h-16 rounded-full object-cover border border-gray-200 shadow-sm" />
              <div>
                <h3 className="font-bold text-lg text-[#1B263A]">{selectedSiswa.nama}</h3>
                <p className="text-xs text-gray-500 font-medium">{selectedSiswa.kelas} • NIS {selectedSiswa.nis}</p>
              </div>
            </div>
      ...
      {step === "camera-food" && selectedSiswa && (
        <div className="w-full bg-white rounded-xl border border-gray-100 overflow-hidden mx-auto shadow-sm">
          ...
          <div className="relative h-[350px] md:h-[450px] bg-black">
