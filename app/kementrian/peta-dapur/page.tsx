// app/kementerian/peta-dapur/page.tsx
'use client';
...
const PetaDapurPage = () => {
  ...
  // Mock data dari ERD - Kitchen table
  const kitchensData = useMemo(() => [
    ...
    },
    {
      ...
      code: 'KTN-BT-002',
      name: 'Dapur Serang Kota',
      address: 'Jl. Raya Serang-Pandeglang KM. 5, Serang',
      phone: '0254-222333',
      latitude: -6.1200,
      longitude: 106.1500,
      province: 'Banten',
    ...
    },
    {
      ...
      code: 'KTN-JT-002',
      name: 'Dapur Solo Baru',
      address: 'Jl. Slamet Riyadi No. 201, Surakarta',
      phone: '0271-654321',
      latitude: -7.5667,
      longitude: 110.8167,
      province: 'Jawa Tengah',
    ...
    },
    {
      ...
      code: 'KTN-JI-001',
      name: 'Dapur Surabaya Timur',
      address: 'Jl. Ahmad Yani No. 333, Surabaya',
      phone: '031-8765432',
      latitude: -7.2575,
      longitude: 112.7521,
      province: 'Jawa Timur',
      city: 'Surabaya',
      picName: 'Rina Susanti',
      picPhone: '081456789012',
      isActive: true,
      totalSchools: 28,
      totalStudents: 13500,
      mealsToday: 13450,
  ...
  const filteredKitchens = useMemo(() => {
    return kitchensData.filter(k => {
      const matchProvince = selectedProvince === 'all' || k.province === selectedProvince;
      ...
      return matchProvince && matchStatus && matchSearch;
    });
  }, [kitchensData, selectedProvince, selectedStatus, searchQuery]);

  const provinces = useMemo(() => {
    const uniqueProvinces = [...new Set(kitchensData.map(k => k.province))];
  ...
  return (
    <MinistryLayout currentPage="peta-dapur">
      <div className="p-4 md:p-6 lg:p-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-gray-900">Peta Lokasi Dapur Nasional</h1>
          <p className="text-sm text-gray-600 mt-1">Monitoring lokasi dan status dapur MBG di seluruh Indonesia</p>
        </div>
                    ...
                    >
                      ...
                      <div className="space-y-1 text-xs text-gray-600">
                        <div className="flex items-center gap-1">
                          ...
                          <span className="truncate">{kitchen.city}, {kitchen.province}</span>
                        </div>
                        <div className="flex items-center gap-1">
