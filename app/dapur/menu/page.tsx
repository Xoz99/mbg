...
const MenuPlanning = () => {
  ...
  // Weekly Menu - Sesuai ERD: WeeklyMenu
      ...
      {viewMode === 'calendar' && (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {currentWeeklyMenu.dailyMenus.map((menu) => {
            ...
            return (
              <div key={menu.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg hover:border-[#D0B064] transition-all group">
                {/* Header */}
                ...
                <div className="p-5">
                  {/* Menu Name */}
                  <h3 className="font-bold text-gray-900 text-base mb-2 leading-tight min-h-[48px]">
                    {menu.menuName}
                  </h3>
                  ...
                  <div className="space-y-2 mb-4 text-sm">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold text-gray-900">{menu.cookingStartAt} - {menu.cookingEndAt}</span>
                    </div>
                  </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Hari/Tanggal</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Menu</th>
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Tingkat</th>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Biaya/Tray</th>
                  ...
                  return (
                    <tr key={menu.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        ...
                        <p className="text-xs text-gray-500">Total: Rp {(menu.estimatedCost * menu.expectedTrays / 1000000).toFixed(1)}jt</p>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <button
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl max-w-5xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            ...
            <div className="p-6 space-y-6">
              {/* Nutrition Grid */}
              <div>
                <h4 className="font-bold text-gray-900 mb-3 text-sm uppercase tracking-wide">Informasi Gizi per Porsi</h4>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-semibold text-gray-900 text-lg">{selectedMenu.expectedTrays.toLocaleString()}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-semibold text-gray-900">{selectedMenu.cookingStartAt} - {selectedMenu.cookingEndAt}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-xl border border-purple-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="font-bold text-purple-900 text-lg">Rp {selectedMenu.estimatedCost.toLocaleString()}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-xl border border-purple-200">
                    <TrendingUp className="w-5 h-5 text-purple-600" />
                    <div className="flex-1">
                      ...
                      <p className="font-bold text-purple-900 text-lg">Rp {(selectedMenu.estimatedCost * selectedMenu.expectedTrays).toLocaleString()}</p>
                    </div>
                  </div>
                </div>

                <div className="space-y-3">
                  <h4 className="font-bold text-gray-900 text-sm uppercase tracking-wide">Tingkat Kesulitan</h4>
                  <div className="flex items-center gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                    {(() => {
                      const diffConfig = getDifficultyConfig(selectedMenu.difficulty);
                      return (
                        <div className={`flex-1 text-center py-3 rounded-lg ${diffConfig.color}`}>
                          <p className="text-3xl mb-2">{diffConfig.icon}</p>
                          <p className="font-bold text-lg">{diffConfig.text}</p>
                        </div>
                      );
                    })()}
                  </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl p-5 border border-blue-100">
                  <div className="grid md:grid-cols-2 gap-3">
                    {selectedMenu.ingredients.map((ingredient: any) => (
                      <div key={ingredient.id} className="flex items-center justify-between p-4 bg-white rounded-lg border border-blue-200 hover:border-blue-300 transition-colors">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            {ingredient.notes && (
                              <p className="text-xs text-gray-500 mt-0.5">{ingredient.notes}</p>
                            )}
                          </div>
                        </div>
                        <div className="text-right">
